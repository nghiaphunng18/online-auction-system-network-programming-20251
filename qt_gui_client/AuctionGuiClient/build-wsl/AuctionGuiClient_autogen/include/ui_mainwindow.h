...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formConnect->setWidget(0, QFormLayout::LabelRole, lblHost);

        edtHost = new QLineEdit(pageConnect);
        edtHost->setObjectName("edtHost");

        formConnect->setWidget(0, QFormLayout::FieldRole, edtHost);

        lblPort = new QLabel(pageConnect);
        lblPort->setObjectName("lblPort");

        formConnect->setWidget(1, QFormLayout::LabelRole, lblPort);
        ...
        formConnect->setWidget(1, QFormLayout::FieldRole, spinPort);
        ...
        spConnect = new QSpacerItem(200, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spConnectBottom = new QSpacerItem(20, 200, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spLogin = new QSpacerItem(200, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spLoginBottom = new QSpacerItem(20, 200, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spHomeHeader = new QSpacerItem(200, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spRoomsRightBottom = new QSpacerItem(20, 120, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        spHistTools = new QSpacerItem(200, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spChatUsers = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spRoomUsers = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spRoomHeader = new QSpacerItem(200, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spQueueBtns = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spDraftBtns = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
        ...
        spEndedBtns = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
